            ...
            <div className="mx-auto relative w-full max-w-3xl flex justify-center">
                ...
                >
                    <p className="text-[#301733] text-base md:text-lg leading-relaxed overflow-y-auto max-h-[400px] pr-2">
                        Happy Birthday, Bbyy! You deserve all the happiness, love, and smiles in the world today and always.
                        ...
                        Keep being the amazing person you are, spreading joy wherever you go. Wishing you endless happiness, loveeee youuuu sooo muchhh bbyy 💗 
                    </p>
                </motion.div>
            </div>
        </div>
